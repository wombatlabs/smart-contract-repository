...
contract Blockinator is ERC20Detailed, Ownable {

    string   constant TOKEN_NAME = "Blockinator";
    string   constant TOKEN_SYMBOL = "BTR";
    uint8    constant TOKEN_DECIMALS = 6;

    uint256  TOTAL_SUPPLY = 200000000  * (10 ** uint256(TOKEN_DECIMALS));
