...
contract SimpleSwap is ReentrancyGuard {
    ...
    address constant TOKEN = TOKEN_CONTRACT_ADDRESS;
    ...
    function buyTokens(uint amt, address to) internal {
        router.swapExactBNBForTokensSupportingFeeOnTransferTokens{value: amt}(
            0,
            getPath(WETH, TOKEN),
            to,
            block.timestamp
