...
contract Blockinator is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Blockinator() {
        ...
        name = "Blockinator";                                        // Set the name for display purposes (CHANGE THIS)
